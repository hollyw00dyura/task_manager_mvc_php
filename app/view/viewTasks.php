...
<p>
    ...
    echo '<table>';
        ...
        // Сортировка по имени.
        // До нажатие кнопка "Сортировать по возрастанию (Имя)"
        //      нажатие экшен sorted
        // После первого нажатия кнопка "Сортировать по убыванию (Имя)"
        //      нажатие экшен sorted
        // После второго нажатия "Без сортировки"
        //      нажатие экшен sorted
        $sort = Registry::get('sort');
        if ($sort == 0)
            echo 'Кнопка "Сортировать по возрастанию (Имя)"<br>'; //передается sort = 1
        else if ($sort == 1)
            echo 'Кнопка "Сортировать по убыванию (Имя)"<br>'; //передается sort = 2
        else
            echo 'Кнопка "Без сортировки"<br>'; //передается sort = 0
        foreach ($data as $row) {
